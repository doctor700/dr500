...
const devs = ['573517050241351691'];
const db = require('quick.db');
const premium = ['573517050241351691']
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Dr_help','Type Dr_help'];
    var i = -1;
    var j = 0;
...
client.login(NTk0NjA1NTA0MTMxNjI5MDY5.XRe3kQ.JilAQgNqw3pXKoSXCZtj7dwM_Xw
)
